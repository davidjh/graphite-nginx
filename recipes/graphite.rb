...
node.default['graphite']['install_type'] = 'package'
node.default['graphite']['password'] = 'Xcb#R4a7'
node.default['graphite']['user'] = 'graphite'
node.default['graphite']['uwsgi']['socket'] = '/tmp/uwsgi.sock --chmod-socket=666'
